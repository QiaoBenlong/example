    ...
    switch (flag)//flag:页面标志
    {
        ...
        case 2://电阻测量
            ...
            while(TimeTick <= 1000)
            {
                ...
                Ris = (float)(0.9851*sum_R/10-0.8538);
                sum_R = 0;
            }
            TimeTick = 0;
            flag++;
        ...
        case 3://交流损耗测量
            ...
            if(Vol_AC >= 0.869)
            {
                Reduction = (float)(-775.99*Vol_AC*Vol_AC + 1425.3*Vol_AC - 654.36);
            }
            else if(Vol_AC >= 0.405 && Vol_AC < 0.869)
            {
                Reduction = (float)(31.461*Vol_AC - 28.615);
            }
            else if(Vol_AC < 0.405)
            {
                Reduction = (float)(-27813*Vol_AC*Vol_AC*Vol_AC*Vol_AC + 21020*Vol_AC*Vol_AC*Vol_AC - 5644.9*Vol_AC*Vol_AC + 669.53*Vol_AC - 55.748);                
            }
            ...
            //测量短路长度
                ...
                {                
                    ...
                    if(sweep_times == 3)
                    {
                        ...
                        DDS_initSweep(AD9959_CH0, &Sweep[0]);
                        DDS_initSweep(AD9959_CH1, &Sweep[1]);
                        UART2_printf("one.t6.txt=\"%d\"\xff\xff\xff",index_min_short);
                        sweep_times = 0;
                        flag++;//flag = 10,空状态
                    }   
                }
        ...
        case 11:
                ...
                {                
                    ...
                    if(sweep_times == 3)
                    {
                        ...
                        DDS_initSweep(AD9959_CH0, &Sweep[0]);
                        DDS_initSweep(AD9959_CH1, &Sweep[1]);
                        UART2_printf("one.t4.txt=\"%d\"\xff\xff\xff",index_min);
                        sweep_times = 0;
                        flag++;
                    }                   
                }//扫频测开路长度结束
